...
weatherForm.addEventListener("submit", async (e) => {
  ...
  const cityData = await axios.get(
    `http://dataservice.accuweather.com/locations/v1/cities/search?apikey=a1Aa7JCSzw4koBXV0wWHZ76vUDHvQB0n&q=${input}&language=en-us&details=false`
  );
